...
public class IndicatorAnimation extends LinearLayout {
    ...
    public IndicatorAnimation(Context context) {
        super(context);

        mContext = context;
    }

    public IndicatorAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
